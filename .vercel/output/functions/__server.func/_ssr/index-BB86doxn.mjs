...
import { a as SiteHeader, b as StaggerGroup, c as StaggerItem, R as Reveal, S as SiteFooter, W as WHATSAPP_NUMBER } from "./constants-CSsbOOIB.mjs";
import { c as cakes, u as useCart } from "./router-BZqE0qod.mjs";
...
function sanitizeForWhatsApp(value, maxLength) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "contact", className: "mx-auto grid max-w-5xl gap-16 px-6 py-20 md:grid-cols-2 md:py-28 scroll-mt-20", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { delay: 0.1, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: (e) => {
        ...
        const whatsappMessage = ["Hello, I'd like to place a custom order.", "", `Name: ${name}`, `Email: ${email}`, `Custom order details: ${message}`].join("\n");
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("input", { id: "name", name: "name", maxLength: MAX_NAME_LENGTH, required: true, className: "w-full rounded-lg border border-input bg-background px-4 py-3 text-sm outline-none focus:border-accent" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("input", { id: "email", name: "email", type: "email", maxLength: MAX_EMAIL_LENGTH, required: true, className: "w-full rounded-lg border border-input bg-background px-4 py-3 text-sm outline-none focus:border-accent" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("textarea", { id: "msg", name: "message", rows: 5, maxLength: MAX_MESSAGE_LENGTH, required: true, className: "w-full rounded-lg border border-input bg-background px-4 py-3 text-sm outline-none focus:border-accent" })
        ] }),
