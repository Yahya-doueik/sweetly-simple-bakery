...
import { a as SiteHeader, R as Reveal, S as SiteFooter, W as WHATSAPP_NUMBER } from "./constants-CSsbOOIB.mjs";
import { u as useCart } from "./router-BZqE0qod.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mx-auto max-w-6xl px-6 py-16 md:py-20", children: [
      ...
      items.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(Reveal, { className: "mt-16 rounded-2xl border border-border/60 bg-card p-12 text-center", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", hash: "menu", className: "mt-6 inline-block rounded-full bg-primary px-7 py-3 text-sm font-medium text-primary-foreground", children: "Browse the menu" })
