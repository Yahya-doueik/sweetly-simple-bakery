...
import { C as resolveManifestAssetLink, D as rootRouteId, o as getNormalizedURL, p as getOrigin, b as attachRouterServerSsrUtils, i as defineHandlerCallback, f as createSerializationAdapter, e as createRawStreamRPCPlugin, r as invariant, u as isNotFound, v as isRedirect, w as isResolvedRedirect, z as mergeHeaders, l as executeRewriteInput, h as defaultSerovalPlugins, y as makeSerovalPlugin } from "../_libs/tanstack__router-core.mjs";
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-GtjN7J5v.mjs");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-IxDu2Vjv.mjs").then((n) => n.r),
